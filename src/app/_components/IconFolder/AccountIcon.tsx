...
export default function AccountIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img" aria-labelledby="a5cs8fgrgw3wt4bo9y0oqquney83txnh" ><title id="a5cs8fgrgw3wt4bo9y0oqquney83txnh">Account</title>
