...
export default function NotificationsIcon() {
  return (
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img" aria-labelledby="alpiwrykh5342mlbvxni7vv8e5odh02h" ><title id="alpiwrykh5342mlbvxni7vv8e5odh02h">Notifications</title>
