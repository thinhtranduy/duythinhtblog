...
export default function OrganizationIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" role="img" aria-labelledby="acl6elsm70ls29r5ohg89u86nzv50dy4" ><title id="acl6elsm70ls29r5ohg89u86nzv50dy4">Organization</title>
